...
from scanner import fetch_cdx, run_recon_pipeline
from filters import filter_urls
from tools import is_root_domain
...
def cmd_subdomains(args):
    ...
    from tools import run_subdomain_discovery
